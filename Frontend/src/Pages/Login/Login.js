...
export default function Login(){
    return (
        <>
            <section className="relative py-20 2xl:py-40 bg-gray-800 overflow-hidden h-screen pt-5">
                <img className="hidden lg:block absolute inset-0 mt-32" src="zospace-assets/lines/line-mountain.svg"
                     alt=""/>
                    <img className="hidden lg:block absolute inset-y-0 right-0 -mr-40 -mt-32"
                                ...
                                <div className="flex flex-wrap items-center -mx-4">
                                    <div className="w-full lg:w-1/2 px-4 mb-16 lg:mb-0">
                                        <div className="max-w-md">
                                            ...
                                            <h2 className="mt-8 mb-12 text-5xl font-bold font-heading text-white">Start
                                                your organised learning journey</h2>
                                    ...
                                    <div className="w-full lg:w-1/2 px-4">
                                        <div className="px-6 lg:px-20 py-12 lg:py-24 bg-gray-600 rounded-lg">
                                            <form action="#">
                                                <h3 className="mb-10 text-2xl text-white font-bold font-heading">Register
                                                    Account</h3>
                                                <div className="flex items-center pl-6 mb-3 bg-white rounded-full">
                <span className="inline-block pr-3 py-2 border-r border-gray-50">
                  <svg className="w-5 h-5" width="20" height="21" viewBox="0 0 20 21" fill="none"
    ...
    fill="black"/>
                    <rect x="15" y="15" width="5" height="1" rx="0.5" fill="black"/><rect x="17" y="18" width="5"
    height="1" rx="0.5"
    ...
    fill="black"/>
                                                    ...
                                                    <input
                                                        ...
                                                        type="email" placeholder="example@edubuzz.com"/>
                                                </div>
                                                <div className="flex items-center pl-6 mb-3 bg-white rounded-full">
                <span className="inline-block pr-3 py-2 border-r border-gray-50">
                  <svg className="w-5 h-5" width="17" height="21" viewBox="0 0 17 21" fill="none"
                       xmlns="http://www.w3.org/2000/svg">
                    <path
    ...
    fill="black"/>
                                                ...
                                                <button
                                                    className="py-4 w-full bg-blue-500 hover:bg-blue-600 text-white font-bold rounded-full transition duration-200">Get
                                                    started
                                                </button>
                                            </form>
                                        </div>
